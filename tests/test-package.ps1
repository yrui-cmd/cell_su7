...
$pluginRoot = Join-Path $repoRoot 'plugins\cell_su7'
$skillRoot = Join-Path $pluginRoot 'skills\cell_su7'
$required = @(
    'plugins\cell_su7\skills\cell_no_ai\SKILL.md',
    'plugins\cell_su7\skills\cell_no_ai\references\api.md',
    ...
    'plugins\cell_su7\.codex-plugin\plugin.json',
    'plugins\cell_su7\skills\cell_su7\SKILL.md',
    'plugins\cell_su7\skills\cell_su7\references\platform-contract.json',
    'plugins\cell_su7\skills\cell_su7\scripts\run_cell_ppt.ps1',
    'plugins\cell_su7\skills\cell_su7\scripts\run_cell_ppt_ooxml.py',
    'plugins\cell_su7\skills\cell_su7\scripts\run_from_svg.ps1',
    'plugins\cell_su7\skills\cell_su7\scripts\run_from_svg.py',
    'plugins\cell_su7\skills\cell_su7\scripts\run_from_image.ps1',
    'plugins\cell_su7\skills\cell_su7\scripts\run_from_image.py',
    'plugins\cell_su7\skills\cell_su7\scripts\set-xiaomiao-key.ps1',
    'plugins\cell_su7\skills\cell_su7\scripts\set_xiaomiao_key.py',
    'plugins\cell_su7\skills\cell_su7\scripts\configure_runtime.py',
    'plugins\cell_su7\skills\cell_su7\scripts\xiaomiao.ps1',
    'plugins\cell_su7\skills\cell_su7\scripts\xiaomiao.py'
)
...
if ($plugin.name -ne 'cell_su7' -or $plugin.version -ne '0.4.3' -or $plugin.skills -ne './skills/' -or $plugin.license -ne 'MIT') { throw 'Plugin identity is invalid.' }
...
if ($runtime.codex.skillId -ne 'cell_su7' -or $runtime.platform.macBackend -ne 'editable-ooxml') { throw 'Runtime contract identity is invalid.' }
...
foreach ($phrase in @('name: cell_su7', 'platform-contract.json', 'runtime-profile.json', 'chat', 'macOS', 'standard input', 'path-return SVG')) {
...
try {
    ...
    $installed = Join-Path $installRoot 'cell_su7\SKILL.md'
    ...
    $profilePath = Join-Path $installRoot 'cell_su7\runtime-profile.json'
...
Write-Output 'PACKAGE_OK|skill=cell_su7|version=0.4.3|platforms=windows,macos|freeze=removed|secret_scan=clean'
