...
$required = @(
    ...
    'plugins\cell-ppt\skills\cell-ppt\references\platform-contract.json',
    'plugins\cell-ppt\skills\cell-ppt\scripts\run_cell_ppt.ps1',
    'plugins\cell-ppt\skills\cell-ppt\scripts\run_cell_ppt_ooxml.py',
    'plugins\cell-ppt\skills\cell-ppt\scripts\run_from_svg.ps1',
    'plugins\cell-ppt\skills\cell-ppt\scripts\run_from_svg.py',
    'plugins\cell-ppt\skills\cell-ppt\scripts\run_from_image.ps1',
    'plugins\cell-ppt\skills\cell-ppt\scripts\run_from_image.py',
    'plugins\cell-ppt\skills\cell-ppt\scripts\set-xiaomiao-key.ps1',
    'plugins\cell-ppt\skills\cell-ppt\scripts\set_xiaomiao_key.py',
...
if ($plugin.name -ne 'cell-ppt' -or $plugin.version -ne '0.2.0' -or $plugin.skills -ne './skills/' -or $plugin.license -ne 'MIT') { throw 'Plugin identity is invalid.' }
...
if ($runtime.codex.skillId -ne 'cell-ppt' -or $runtime.platform.macBackend -ne 'editable-ooxml') { throw 'Runtime contract identity is invalid.' }
...
foreach ($phrase in @('name: cell-ppt', 'platform-contract.json', 'runtime-profile.json', 'chat', 'macOS', 'Sole filtering rule', 'standard input', 'path-return SVG')) {
...
Write-Output 'PACKAGE_OK|skill=cell-ppt|version=0.2.0|platforms=windows,macos|freeze=removed|secret_scan=clean'
