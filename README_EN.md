...
This standalone repository contains the complete `cell_su7` skill with both drawing backends. Windows: run `setup.ps1`. macOS: run `bash setup.sh` for the editable PPTX backend. Illustrator retains its Windows / open Illustrator 2026 requirement.
